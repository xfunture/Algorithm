...
def runstrat():
    ...
    # Load the Data
    datapath = args.dataname or '/home/rick/data/BTCUSDT_20190101_20191231_minute.csv'
    ...
    # Resample the data
    if args.noresample:
        datapath = args.dataname2 or '/home/rick/data/BTCUSDT_20190101_20191231_daily.csv'
...
def resample():
    dataname = '/home/rick/data/BTCUSDT_20190101_20191231.csv'
    data = MyHLOC(dataname = dataname)
    cerebro = bt.Cerebro()
